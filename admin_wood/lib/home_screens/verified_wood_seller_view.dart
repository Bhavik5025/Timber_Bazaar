...
class verified_wood_seller extends StatefulWidget {
  @override
...
class _v_wood extends State<verified_wood_seller> {
  List<WoodSeller> woodsellers = [];
  void fetchwoodsellers() async {
    var uid = FirebaseAuth.instance.currentUser!.uid;
    var data = await FirebaseFirestore.instance.collection("wood_seller").get();
    mapwoodseller(data);
  }
